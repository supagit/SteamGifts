 ...
 */
public class SavedGamesMustHaveList extends SavedElements<GameInfo> {
    static final String DB_TABLE = "musthavelist";

    public SavedGamesMustHaveList(Context context) {
