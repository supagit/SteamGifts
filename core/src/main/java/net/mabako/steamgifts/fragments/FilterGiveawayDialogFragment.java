...
public class FilterGiveawayDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ((CheckBox) view.findViewById(R.id.filter_group_restricted)).setChecked(f.isShowGroupOnly());
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        newFilterData.setShowGroupOnly(getValueAndUpdateFlags(R.id.filter_group_restricted, oldFilterData.isShowGroupOnly()));
